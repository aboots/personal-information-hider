...
class NameDetection:
    def __init__(self):
        file = open('personal_information_hider/resources/last_names_regex.json', 'r', encoding="utf-8")
        self.last_names_reg = json.loads(file.read())
        file.close()

        file = open('personal_information_hider/resources/first_names_regex.json', 'r', encoding="utf-8")
